...
def main():
    ...
    # Paths as per issue description
    input_root = "/Users/kkreth/PycharmProjects/data/simplified_output_broken_down_filtered"
    map_path = "/Users/kkreth/PycharmProjects/cgan/cube_centroid_mapping/df_all_possible_combinations_with_neighbors.csv"
    output_root = "/Users/kkreth/PycharmProjects/data/simplified_cubes"
    ...
    # Using initializer to load the large map file once per process instead of serializing it 13k times
    results_count = 0
    errors = []
